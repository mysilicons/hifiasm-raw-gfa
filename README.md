...
# 0) Get the code
# (HTTPS)
git clone https://github.com/mysilicons/hifiasm-raw-gfa.git
cd hifiasm-raw-gfa
# (or SSH)
# git clone git@github.com:mysilicons/hifiasm-raw-gfa.git && cd hifiasm-raw-gfa
...
* **License**: MIT License (following the upstream project). See the root [`LICENSE`](LICENSE) file for the full text.
